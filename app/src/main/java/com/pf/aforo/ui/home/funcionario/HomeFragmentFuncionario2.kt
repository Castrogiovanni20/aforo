...
class HomeFragmentFuncionario2 : Fragment(R.layout.fragment_home_funcionario) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //Graficos:
        piechart = FragmentHomeFuncionarioBinding.bind(view)
        barChar = FragmentHomeFuncionarioBinding.bind(view)
